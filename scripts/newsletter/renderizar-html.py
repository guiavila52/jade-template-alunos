...
def renderizar_assinatura():
    ...
    html += '<tr>\n'
    html += '<td style="width:96px; vertical-align:top; padding-right:16px;"><img src="https://sites.{{DOMINIO}}/assets-gui/foto-gui-barcelona-circular.png" alt="{{NOME_OPERADOR}}" width="96" height="96" style="width:96px; height:96px; border-radius:50%; object-fit:cover; object-position:center 25%; display:block; border:0;"></td>\n'
    html += '<td style="vertical-align:top; font-size:14px; line-height:1.5; color:#4a4a4a;">\n'
    html += '<strong style="color:#1a1a1a; font-size:16px; font-weight:700; display:block; margin-bottom:4px;">{{NOME_OPERADOR}}</strong>\n'
