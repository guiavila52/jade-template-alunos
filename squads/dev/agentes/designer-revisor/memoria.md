# Memória — @designer-revisor (squad-dev)
...
- Output canônico: `workspace/output/auditorias/revisao-visual-{slug}-{YYYY-MM-DD-HHMM}.md`
- **Skill própria:** `/revisar-visual` (criada 11/05/2026, Onda B4)
...
- `segundo-cerebro/01-identidade/` — tom visual do {{NOME_OPERADOR}} (paleta, foto, voz)
- `segundo-cerebro/02-negocios/` — paleta por produto ({{EMPRESA_NEGOCIO}} ≠ Projeto {{NOME_OPERADOR}} ≠ {{EMPRESA_COFUNDADA}})
...
- Brand consistency {{NOME_OPERADOR}} = preto/dourado em LP, paleta Light Copy em carrossel
