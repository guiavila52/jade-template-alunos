# MAPA — squads/jade/agentes/

> Última atualização: 07/05/2026

## Propósito

Agentes do squad-jade (camada de orquestração estratégica). Squad-jade NÃO produz entregáveis — orquestra (Jade) e define ângulo/posicionamento (estrategista) ANTES da copy ir pra produção.
