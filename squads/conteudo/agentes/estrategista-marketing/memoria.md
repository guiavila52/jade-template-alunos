...
| `angulo_unico` | recorte único pro {{NOME_OPERADOR}} | "Maioria erra na orquestração, não na IA" |
...
2. Identifica 3 candidatos de ângulo único (não 1 — {{NOME_OPERADOR}} escolhe melhor depois)
3. Pra cada candidato: ângulo + payoff + estrutura + lâminas
4. Recomenda 1 com justificativa
5. Despacha pro carrossel só o escolhido (ou aguarda {{NOME_OPERADOR}} se ambíguo)
