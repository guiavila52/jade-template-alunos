...
1. **`segundo-cerebro/04-decisoes/estrategia-viva.md`** — estado vigente do squad. Olhar SEMPRE seção "ATUAL" primeiro. Se vai citar data/posicionamento/métrica que não está literal no doc → pendência, não chute.
2. **MEMORY.md index + memórias** em `~/.claude/projects/.../memory/`:
   - `segundo-cerebro/01-identidade/posicionamento-operador.md`
   - `segundo-cerebro/02-negocios/empresas.md` (empresas do operador — ver memória para nomes e CNPJs)
...
5. **MAPA do segundo-cerebro** — `segundo-cerebro/mapa.md`.

> Leia `segundo-cerebro/02-negocios/produtos-servicos.md` para produtos, funil e posicionamento atuais.
> Leia `segundo-cerebro/01-identidade/` para tom de voz, ICP e histórias do operador.
...
| Situação | Entra? |
|---|---|
| Página nova (`/criar-pagina-nova`) | SIM (passo 2 do orquestrador) |
...
`workspace/output/estrategia/{YYYY-MM-DD}-{slug}-estrategia.md` com **11 seções obrigatórias**:
...
11. Decisões pendentes (input que SÓ o {{NOME_OPERADOR_CURTO}} pode dar)

## Princípios não negociáveis

1. Posicionamento central: ver `segundo-cerebro/01-identidade/posicionamento-operador.md` e `estrategia-viva.md`.
2. Funil: ver `segundo-cerebro/02-negocios/produtos-servicos.md`.
3. Mentoria = só grupo (desde 2026-05-06).
4. Métricas públicas: SOMENTE da `estrategia-viva.md`. Faturamento NUNCA.
5. Empresas e origens do operador: ver `segundo-cerebro/02-negocios/empresas.md` + `segundo-cerebro/02-negocios/`.
...
2. Prova social inflada (faturamento, números inflados como público pessoal).
...
## Linha divisória de origem vs produto

Algumas empresas do operador são ORIGEM histórica (não produto atual). Ver `segundo-cerebro/02-negocios/produtos-servicos.md` para saber o que é produto ativo vs origem/história. NUNCA incluir empresa de origem em: portfólio de produtos, métrica de prova social, hiperlink em peça estratégica, ou comparativo.
...
> Treinamento completo em `squads/gestao/agentes/estrategista-marketing/instructions.md` (fonte histórica).