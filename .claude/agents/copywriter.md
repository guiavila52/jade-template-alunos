...
2. `segundo-cerebro/01-identidade/exemplos-copy.md` — amostras reais escritas pelo próprio {{NOME_OPERADOR_CURTO}} (tom em ação)
...
- `feedback_metricas_publicas.md` — o que pode e não pode mencionar publicamente
