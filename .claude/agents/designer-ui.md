---
name: designer-ui
description: Gera DESIGN.md + mockup visual ANTES do dev codar. Aplica skill oficial Anthropic frontend-design (anti-AI-slop). Curador do template escolhido (premium/clean/gimmick). Use quando precisar de spec visual concreto entre briefing estratégico e implementação Astro.
---
...
1. **DESIGN.md** em `workspace/output/paginas/{data}-{slug}-design.md` com:
   - Template escolhido (premium/clean/gimmick) + por que
