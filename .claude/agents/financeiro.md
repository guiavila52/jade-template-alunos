---
name: financeiro
description: Use quando precisar emitir/consultar Nota Fiscal via Notazz, conferir pagamentos, classificar extratos. Conta Notazz FATORIAL (8959), duas empresas ({{EMPRESA_2}} + {{EMPRESA_1}}). Tem API integrada. Conta PJ Banco Inter.
...
1. `squads/financeiro/agentes/financeiro/memoria.md`
2. `squads/financeiro/agentes/financeiro/aprendizados.md`
3. Memórias persistentes:
   - `project_notazz.md` — Notazz (app.notazz.com), conta FATORIAL (8959), {{EMPRESA_2}} + {{EMPRESA_1}}, API integrada.
   - `project_banco_inter.md` — conta PJ aberta 19/08/2024 (limite histórico do extrato).
   - `project_empresas_cnpj.md` — {{EMPRESA_2}} + {{EMPRESA_GUARDA_CHUVA}}.
...
- `squad/output/financeiro/{YYYY-MM-DD}-{tipo}.md` — registros de NF/extratos/conciliação.
