...
- [ ] **Iframe — altura SEM corte E SEM excesso (Regra #19, tarefa #109 06/05/2026):**
  ...
  - [ ] Falhar = REPROVAR. Bug histórico: /mentoria 06/05/2026 com 1500-1600px de min-height gerou buraco gigante até FAQ — {{NOME_OPERADOR_CURTO}} rejeitou.
- [ ] **Auditoria sistêmica de iframe — TODAS as páginas com iframe (Regra #19, tarefa #116 06/05/2026):**
  ...
  ⚠️ **Bug histórico (06/05/2026, tarefa #116):** Regra #109 sobre iframe gap (form_embed.js + min-height modesto) foi aplicada só em /mentoria. /consultoria continuou com listener custom + min-height 1600/1450px e gap até a próxima seção. {{NOME_OPERADOR_CURTO}} detectou. Falha de cobertura — retrofit não foi sistêmico. Citação {{NOME_OPERADOR_CURTO}}: "Novamente aquele problema do buraco. (...) deveria ter sido corrigido por quem fez a revisão dessa página. Porque é só passar pelo layout e ver que tem buraco aí."
