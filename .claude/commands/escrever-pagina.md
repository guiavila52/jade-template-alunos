...
### Prova social
Ver `/escrever-copy` seção "Prova social — honesta, sobre o GUI, inequívoca". Regra crítica: prova social do {{NOME_OPERADOR_CURTO}} em LP é sobre AUTORIDADE DELE (CEO {{PLATAFORMA_CURSOS}}, autor de livros, YouTube), não números de produto cofundado. Banido: "{{METRICA_PLATAFORMA}}+ usuários" como métrica do {{NOME_OPERADOR_CURTO}}, "N+ empresas" sem fonte, "N continentes".
