...
- [ ] **Assinatura canônica 4 linhas** com capitalização correta:
  ...
  Autor do {{PRODUTO_PRINCIPAL}}, {{PRODUTO_ENTRADA}} e {{PRODUTO_ENTRADA_2}}
...
- [ ] **Avatar circular:**
  ...
  - Fonte canônica: o asset de foto de perfil do operador (`foto-perfil.png`, 540×540)
  - Servido via **Resend attachment CID** (`<img src="cid:avatar-operador">`)
...
2. Usar attachment CID pro avatar (`<img src="cid:avatar-operador">`)
...
### Bugs {{PLATAFORMA_NEWSLETTER}} corrigidos
...
Uma newsletter (caso real) chegou pro {{NOME_OPERADOR_CURTO}} com 4 problemas:
...
**Lição do caso histórico 13/05/2026:** A newsletter do caso tinha markup HTML correto (sem erro de sintaxe), mas padding excessivo + falta de bloco vídeo. Auto-checklist passou batido porque não RENDERIZOU.
