...
Exibir a mensagem de boas-vindas curada e aguardar resposta do aluno.

**Fonte única:** ler e exibir o conteúdo de `.claude/onboarding-aluno.md` palavra por palavra (apresentação + lista de times + pedido de materiais + convite Sistema Reverso), seguindo as instruções daquele arquivo. Nunca duplicar/improvisar a mensagem aqui — ela vive só em `onboarding-aluno.md`.
