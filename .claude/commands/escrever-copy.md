...
- `Segundo Cérebro/01-identidade/banco-de-historias.md` — histórias reais do {{NOME_OPERADOR}} para usar na copy
...
### Origem do {{NOME_OPERADOR}} — narrativa canônica (banco de histórias #0)

O {{NOME_OPERADOR}} é ilusionista desde os 12 anos. Construiu a {{EMPRESA_1}} (maior plataforma de mágica do Brasil). Da {{EMPRESA_1}} nasceu a {{EMPRESA_2}} (plataforma de cursos online white-label, cofundada com {{COFUNDADOR}} — bootstrapped). Hoje o foco do Projeto {{NOME_OPERADOR}} é construir squads de IA pra própria empresa + ensinar/aplicar isso pros alunos via YouTube, Imersão, Mentoria, {{PRODUTO_PRINCIPAL}} e Consultoria.

Fonte canônica: `Segundo Cérebro/01-identidade/banco-de-historias.md` (história #0 — "Origem do {{NOME_OPERADOR}} — {{EMPRESA_1}} → {{EMPRESA_2}}").

**Quando usar essa narrativa em copy:**
- Páginas de produto educacional ({{PRODUTO_PRINCIPAL}}, Imersão, Mentoria, Consultoria) — credibilidade pessoal do {{NOME_OPERADOR}}.
...
- E-mail de boas-vindas / sequência de aquecimento — por que confiar no {{NOME_OPERADOR}}.

**Como usar (exemplos canônicos):**
- "Comecei como ilusionista aos 12 anos."
- "Construí a maior plataforma de mágica do Brasil — a {{EMPRESA_1}}."
- "Da {{EMPRESA_1}} nasceu a {{EMPRESA_2}} — porque a infraestrutura era boa demais pra ficar só pra mágicos."
- Sequência: ilusionismo → {{EMPRESA_1}} → {{EMPRESA_2}} → Squad de IA do Projeto {{NOME_OPERADOR}}.

**Cuidados (linha que NÃO se cruza):**
- {{EMPRESA_1}} **NÃO é produto do squad atual.** É ORIGEM. Não usar em comparativo de produto, lista de produtos do {{NOME_OPERADOR}}, ou métrica de prova social de produto educacional.
- "Cofundador {{EMPRESA_1}}" não conta como autoridade em squad de IA — conta como background empreendedor/biográfico.
- Não inflar — narrativa real, sem dramatizar.
- Não misturar {{EMPRESA_1}} (escola de mágica, projeto à parte sob CNPJ {{EMPRESA_GUARDA_CHUVA}}) com o squad atual (Projeto {{NOME_OPERADOR}}).

**Citação literal do {{NOME_OPERADOR}} (06/05/2026):**
> "O {{EMPRESA_1}} é mais útil pras copies, pra poder contar a minha história, pra dizer de onde que o {{EMPRESA_2}} veio, pra botar o meu background como ilusionista, que eu sou ilusionista desde os meus 12 anos. Não é para ter {{EMPRESA_1}} como posicionamento dos produtos. O {{EMPRESA_1}} tem que estar incluso na parte de copy, na história sobre quem eu sou, quem o {{NOME_OPERADOR}} é."


## Métricas do {{NOME_OPERADOR}} — o que pode e o que NÃO pode mencionar publicamente

**Pode mencionar livremente:**
- {{EMPRESA_2}}: mais de 400 mil usuários ativos / centenas de criadores hospedando cursos / cofundada com {{COFUNDADOR}}
- {{EMPRESA_1}}: maior plataforma de mágica do Brasil
- Tempo de mercado / origem (lojas físicas → digital → {{EMPRESA_2}})
...
- Faturamento (R$ /mês ou /ano de QUALQUER empresa do {{NOME_OPERADOR}})
- MRR / ARR / receita
- Lucro
- Margens
- Métricas financeiras internas

**Por quê:** O {{NOME_OPERADOR}} pediu explicitamente em 06/05/2026 que copy nunca exponha faturamento publicamente. Citação:

> "Não pretendo ficar expondo publicamente o faturamento da {{EMPRESA_2}}."
...
**Bug histórico:** /mentoria v2 (06/05/2026) afirmou "{{EMPRESA_2}} fatura mais de 300 mil no mês" — rejeitado pelo {{NOME_OPERADOR}}.
...
8. `squad/agents/copywriter.md` ← suas instruções completas
...
Após ler tudo, pergunte ao {{NOME_OPERADOR}}:
...
Siga o workflow definido em `squad/agents/copywriter.md`. Sempre apresente o rascunho para aprovação antes de finalizar. Ao final, registre aprendizados em `squads/copy/agentes/copywriter/aprendizados.md`.
...
```
[ {{NOME_OPERADOR}} pede copy (ou outra skill delega: /escrever-pagina,
...
[ 5. Apresentar rascunho pra aprovação ] → @copywriter
        ↓
   ┌─────────────────────────────────────┐
   ↓ ({{NOME_OPERADOR}} aprova)               ({{NOME_OPERADOR}} rejeita)
...
**Por quê:** O usuário não preenche formulário pra ser avaliado. Preenche pra resolver um problema dele. Copy fria espanta. Bug histórico /mentoria FAQ "conversa de qualificação" — {{NOME_OPERADOR}} rejeitou em 06/05/2026.

**Citação {{NOME_OPERADOR}}:** "Falar pra pessoa que é uma conversa de qualificação, você vai estar espantando a pessoa. Ninguém quer participar de uma conversa de qualificação. Isso é procedimento interno nosso."
...
✅ "...quem quer trabalhar 1:1 com o {{NOME_OPERADOR}} entra pela [consultoria](https://{{DOMINIO}}/consultoria), que é outro produto."
✅ Em Astro: `<a href="https://{{DOMINIO}}/consultoria" class="link-inline">consultoria</a>`

**Padrão errado (NUNCA escrever):**

❌ "...quem quer trabalhar 1:1 com o {{NOME_OPERADOR}} entra pela consultoria ({{DOMINIO}}/consultoria)..."
...
Todo link interno do {{NOME_OPERADOR}} usa `https://{{DOMINIO}}/[slug]`. Slugs canônicos: magicaonline, manychat, clickup, clickup8x, level, automacoes, reverso, youtube, mentoria, consultoria, ensinio.
...
**Citação {{NOME_OPERADOR}}:** "Não faz sentido botar entre parênteses como texto que a pessoa vai ter que copiar e colar. Isso foi vacilo, tanto de quem fez a página, quanto da revisão."


### Posicionamento de comunidade/turma em produtos com mentor — REGRA

Em produtos onde o {{NOME_OPERADOR}} é o **mentor/consultor principal** (mentoria, consultoria, eventos, cursos com sua presença):
...
- "Você + {{NOME_OPERADOR}} + outros fundadores no mesmo barco"
- "Mentoria direta com {{NOME_OPERADOR}} + grupo curado pra trocar ideia"
- O ATALHO é o {{NOME_OPERADOR}} orientando + estrutura do produto. A comunidade é parte do entorno.

**Por quê:** O {{NOME_OPERADOR}} é o produto. Posicionar comunidade como segredo desvaloriza o motivo da pessoa pagar (que é o {{NOME_OPERADOR}}) e dá sensação de "estou pagando pra estar com a turma". Bug histórico 06/05/2026 na /mentoria v2.

**Citação {{NOME_OPERADOR}}:** "fica parecendo que a pessoa está pagando para estar com a turma. (...) Aí fica parecendo que eu estou vendendo mentoria e o segredo é que a pessoa aprende com os outros. Não sei, não é legal essa pegada."
...
2. **Sobre o {{NOME_OPERADOR}}:** autoridade dele, não números de produto que ele cofundou
...
- "400k+ usuários {{EMPRESA_2}}" — leitor confunde com clientes do {{NOME_OPERADOR}} (são alunos dos clientes da {{EMPRESA_2}})
...
**APROVADO (honesto + sobre o {{NOME_OPERADOR}}):**
- "CEO da {{EMPRESA_2}}" (cargo + empresa = fato verificável)
...
- "Cofundador da {{EMPRESA_1}} — maior plataforma de mágica do Brasil"
- Premiações pessoais, certificações, reconhecimentos

**Dúvidas frequentes:**
- "Posso falar dos 400k usuários da {{EMPRESA_2}}?" → SIM, mas qualificando ("plataforma com 400k+ usuários ativos hospedando cursos") — NÃO como prova social do {{NOME_OPERADOR}} em LP da consultoria/mentoria dele
- "Posso dizer 'já atendi grandes empresas'?" → SIM, e mostrar logos no slider. NÃO números vagos sem fonte

**Por quê:** Bug 06/05/2026 /consultoria — social strip "400k+ usuários · 35+ empresas · 3 continentes" rejeitado. {{NOME_OPERADOR}}:
> "Esses usuários são alunos dos nossos clientes (...) parece que a gente tem 400k clientes (...) eu já atendi muito mais empresas (...) tem que mostrar coisas que importam: avaliações nos meus cursos, inscritos no YouTube, que eu sou CEO da {{EMPRESA_2}}, autor de dois livros."
...
**Citação {{NOME_OPERADOR}} (06/05/2026):** "Eu não tenho certeza se a mentoria vão ser 3 meses ou 4 meses. Então eu não queria afirmar na página da consultoria essa informação. (...) depois a gente muda isso e fica desatualizado."
