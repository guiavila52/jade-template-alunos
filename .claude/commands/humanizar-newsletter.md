...
description: Humaniza newsletter escrita por IA — faz soar como se o {{NOME_OPERADOR_CURTO}} tivesse sentado e escrito. Passa mecânica de 10 regras contra padrões delatores de IA.
type: skill
---
...
**Squad:** conteudo  
**Maturidade:** 🟡 EM TESTE — criada 21/05/2026, afinar com feedback do {{NOME_OPERADOR_CURTO}}  
...
Newsletter escrita por IA tem padrões delatores concretos: ritmo uniforme, conectores formais, adjetivos vazios, neutralidade total. Este pass aplica 10 correções mecânicas para fazer o texto soar como o {{NOME_OPERADOR_CURTO}} escreveu — casual, direto, com posição, com ritmo humano.
...
- Quando {{NOME_OPERADOR_CURTO}} falar "tá cheirando IA" em qualquer texto
...
**Padrões de voz do {{NOME_OPERADOR_CURTO}}:**
...
### Regra 10 — PT-BR informal (tom {{NOME_OPERADOR_CURTO}})

Ajustes de voz para o português do {{NOME_OPERADOR_CURTO}}:
