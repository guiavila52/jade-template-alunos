...
2. **Confirmar com Gui** que aba foi fechada (uma confirmação explícita por execução).
...
**PARAR. Aguardar "aprovado" explícito do Gui.** Não executar `mv` sem aval.
