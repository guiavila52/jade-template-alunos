...
1. **`Segundo Cérebro/04-decisoes/estrategia-viva.md`** — pra checar se data/métrica/posicionamento citado bate com estado vigente.
2. **`squads/jade/agentes/estrategista/instructions.md`** — formato canônico de 11 seções + princípios + anti-padrões.
3. **`squads/jade/agentes/estrategista/aprendizados.md`** — não aprovar repetição de erro já corrigido.
4. **MEMORY.md** — checar se a estratégia bate com posicionamento e feedbacks ativos.
5. **O documento estratégico submetido** — `squad/output/estrategia/{YYYY-MM-DD}-{slug}-estrategia.md`.

Se o documento NÃO existe → devolve pra `@estrategista` com nota.

---

## Inputs esperados

- Caminho do documento de estratégia (`squad/output/estrategia/{YYYY-MM-DD}-{slug}-estrategia.md`)
- Tarefa # de origem
...
- [ ] Rodapé cita fontes consultadas (Segundo Cérebro + memórias usadas)
...
`squad/output/estrategia/{YYYY-MM-DD}-{slug}-revisao.md`
...
**Documento revisado:** squad/output/estrategia/{YYYY-MM-DD}-{slug}-estrategia.md
**Revisor:** Jade (COO)
