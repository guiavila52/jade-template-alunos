...
>
> Acionada por `/criar-pagina-nova` (passo 2), por `/jade` (quando há decisão de produto/oferta) ou diretamente pelo Gui.
...
7. **`segundo-cerebro/01-identidade/banco-de-historias.md`** (se existir) — histórias canônicas do Gui pra usar como gancho.
...
- [ ] Não inventou conteúdo sobre o Gui (tudo citado tem fonte no segundo-cerebro)
...
Se input foi transcrição YouTube: estrategista identifica **3 candidatos de ângulo único** (não 1 — Gui escolhe o melhor) e recomenda 1 com justificativa.
