...
```bash
REPO="/Users/{{SEU_USUARIO}}/Documents/Projetos IA {{NOME_OPERADOR}}/Páginas Astro {{NOME_OPERADOR}}"
...
Tabela markdown impressa direto no chat. Jade usa pra mapear estado do funil quando {{NOME_OPERADOR}} pedir "lista as paginas que temos".

## Quando usar

- {{NOME_OPERADOR}} perguntar quais paginas existem
