...
Tabela markdown impressa direto no chat. Jade usa pra mapear estado do funil quando Gui pedir "lista as paginas que temos".

## Quando usar

- Gui perguntar quais paginas existem
