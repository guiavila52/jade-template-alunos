...
- Ao final da esteira `/criar-pagina` (depois do `/revisar-codigo-pagina` aprovar)
- Ao final da esteira `/migrar-pagina` (depois do `/revisar-codigo-pagina` aprovar)
- ANTES de `/publicar-pagina`
- ANTES de qualquer apresentação ao Gui
...
Gerar arquivo em `Squad Empresa {{NOME_OPERADOR}}/squad/output/paginas/YYYY-MM-DD-[slug]-bateria-testes.md` com:
