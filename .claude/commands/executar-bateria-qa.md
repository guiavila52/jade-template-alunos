...
[
  ...
  "https://sites.{{DOMINIO}}/{{SLUG_PRODUTO_2}}",
  "https://sites.{{DOMINIO}}/{{SLUG_PRODUTO_3}}",
  "https://sites.{{DOMINIO}}/{{SLUG_PRODUTO_ENTRADA_2}}",
  "https://sites.{{DOMINIO}}/{{SLUG_ISCA_1}}",
  "https://sites.{{DOMINIO}}/{{SLUG_PRODUTO_PRINCIPAL}}",
  "https://sites.{{DOMINIO}}/sobre",
  "https://sites.{{DOMINIO}}/{{SLUG_ISCA_2}}"
]
```
...
- {{GTM_CONTAINER_ID}} presente >= 2 ocorrências (script head + noscript body)
- Favicon canônico (`/images/favicon.ico` + `/images/favicon.png`)
...
- `feedback_gtm_obrigatorio.md` (#147) — {{GTM_CONTAINER_ID}}
...
## Página: https://sites.{{DOMINIO}}/sua-pagina
