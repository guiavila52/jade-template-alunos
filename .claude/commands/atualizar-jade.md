...
- Quando ver no LinkedIn/YouTube/Newsletter do Gui que tem nova feature no squad
...
| "Persona modificada" warning | Upstream tentou tocar persona (bug do template) | Revert do arquivo + report Gui |
