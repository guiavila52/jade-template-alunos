---
name: revisar-carrossel
description: Audita copy de carrossel Instagram antes da geracao de imagens (squad-conteudo -> revisor-carrossel).
type: skill
---
...
```
/revisar-carrossel workspace/output/carrosseis/YYYY-MM-DD-[slug]/roteiro.md
```
...
- [ ] Linguagem está no tom do {{NOME_OPERADOR_CURTO}}? (direto, sem formalidade excessiva, sem jargão vazio)
...
Registrar o resultado em `squads/conteudo/agentes/designer-conteudo/aprendizados.md`:
...
[ 2. Aplicar checklist slide a slide ] → @revisor-carrossel
   ...
   - Intermediários: 1 premissa por slide + transição lógica
                     + tom do {{NOME_OPERADOR_CURTO}} + cabe em ~180 chars
...
[ 3. Registrar resultado ] → @revisor-carrossel
   squads/conteudo/agentes/designer-conteudo/aprendizados.md
