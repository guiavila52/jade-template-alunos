# Pipeline de Páginas — Histórico

> Gerado automaticamente pela skill `/criar-pagina-nova` (Jade).
> Cada entrada representa um pipeline completo executado.
...
```
## [slug] — YYYY-MM-DD
Produto, objetivo, ângulo, paths dos arquivos,
ciclos de revisão, status final e aprendizados.
```
...
**Aprendizados:** h2 e sec-label não podem ter o mesmo texto (prejudica hierarquia semântica); evitar !important para compensar elementos dinâmicos como sticky bar — usar seletor mais específico.
